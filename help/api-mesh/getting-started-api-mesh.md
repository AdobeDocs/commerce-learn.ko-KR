---
title: API Mesh 시작
description: App Builder 설치, 프로젝트 작업 및 역방향 프록시 만들기를 포함하여 Adobe Commerce 및 Adobe App Builder에서 API Mesh를 사용하는 방법을 알아봅니다.
jira: KT-11802
doc-type: Tutorial
duration: 422
...
[전체 API Mesh 설명서 보기](https://developer.adobe.com/graphql-mesh-gateway/mesh/){target="_blank"}
...
>[!VIDEO](https://video.tv.adobe.com/v/3421889?captions=kor&learn=on)
...
Adobe App Builder 및 API Mesh를 사용하는 개발자는 역방향 프록시의 정의를 이해할 필요가 없습니다. 그러나 Adobe App Builder과 관련된 전반적인 기능에 관심이 있는 경우 다음 리소스를 사용하십시오.

...
2. `database`$MAGENTO_CLOUD_RELATIONSHIPS`type` 변수의 [&#x200B; 및 &#x200B;](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/configure/app/properties/properties.html?lang=ko#relationships) 속성에서 MySQL 로그인 자격 증명을 검색합니다.

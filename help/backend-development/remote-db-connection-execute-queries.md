...
2. [$MAGENTO_CLOUD_RELATIONSHIPS](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/configure/app/properties/properties.html?lang=en#relationships) 변수의 `database` 및 `type` 속성에서 MySQL 로그인 자격 증명을 검색합니다.

---
title: Adobe App Builder 및 Adobe Commerce을 사용하여 IO 이벤트 시작하기
description: Adobe I/O Events 시작하기 Adobe Commerce 이벤트에 대한 App Builder 런타임 작업을 만듭니다.
...
Adobe I/O 이벤트에 대해 알아봅니다. 이 데모에서는 Adobe Commerce의 이벤트와 Adobe Commerce의 이벤트를 사용하여 Slack 채널로 보냅니다.

## 이 비디오는 누구의 것입니까?

* Adobe Commerce 및 Adobe IO 이벤트를 사용하여 이벤트 기반 애플리케이션을 구축하는 방법을 학습하는 개발자입니다.

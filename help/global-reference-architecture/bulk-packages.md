---
title: 벌크 패키지 글로벌 참조 아키텍처 패턴
description: 효율적인 코드 관리, 버전 제어 및 확장 가능한 다중 인스턴스 배포를 위해 벌크 패키지 GRA 패턴을 사용하여 Adobe Commerce을 설정하는 방법에 대해 알아봅니다.
jira: KT-16726
doc-type: Tutorial
duration: 296
...
* GRA의 시맨틱 버전 관리 지원
* 단순성, 개발자는 일반적인 단일 스토어 개발 패턴보다 더 많은 기술이 필요하지 않음

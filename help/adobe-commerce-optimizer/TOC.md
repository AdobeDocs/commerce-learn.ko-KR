...
+ [개요](./overview.md)
+ [Adobe Commerce Optimizer의 첫 번째 인스턴스 만들기](./create-first-instance.md)
+ [Adobe Commerce Optimizer 인스턴스 관리](./managing-instances.md)
+ [샘플 데이터 수집](./ingest-sample-data.md)
+ [GraphQL을 사용한 첫 번째 쿼리](./first-query.md)
+ Salesforce Commerce Cloud 스타터 키트 {#sfcc-starter-kit}
   + [개요](./sfcc-starter-kit/overview.md)
   + [아키텍처 개요](./sfcc-starter-kit/architecture-overview.md)

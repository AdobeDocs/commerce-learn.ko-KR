---
title: Adobe Commerce 클라우드 배포 전략, 테스트, 모니터링 및 보안
description: Adobe Commerce 클라우드 배포 전략, 테스트, 모니터링 및 보안에 대해 알아봅니다.
feature: Cloud
...
Adobe Commerce 클라우드 배포 전략, 테스트 모범 사례, 모니터링 및 보안 도구에 대해 알아봅니다.
...
* [Fastly WAF 웹 애플리케이션 방화벽](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/cdn/fastly-waf-service.html?lang=ko)

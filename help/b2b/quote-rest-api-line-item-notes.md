...
description: Adobe Commerce REST API를 사용하여 B2B 판매 견적에 라인 항목 메모를 추가 및 검색하고, 구매자 및 판매자 댓글에 프로그래밍 방식으로 액세스하는 방법에 대해 알아봅니다.
...
>[!VIDEO](https://video.tv.adobe.com/v/3443492?captions=kor&learn=on)

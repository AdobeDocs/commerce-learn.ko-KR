---
title: GraphQL을 사용하여 라인 항목 할인 표시
description: GraphQL을 사용하여 Adobe Commerce의 B2B 판매 견적에 라인 항목 할인을 적용하고 쿼리 응답에서 결과 할인 값을 검색하는 방법을 알아봅니다.
...
라인 항목 할인을 사용하고 GraphQL에서 값을 보는 방법에 대해 알아봅니다.

---
title: Commerce 통합 스타터 키트 모범 사례
description: GitHub 설정 및 온보딩에서 배포, 유효성 검사 및 라이브까지 스타터 키트를 사용하는 Adobe Commerce 통합에 대한 모범 사례에 대해 알아봅니다.
...
* 이벤트 공급자 구성, 구독 및 시스템 간 동기화에 대한 정보를 원하는 소프트웨어 엔지니어와 개발자입니다.

## 비디오 콘텐츠

* 복제에서 라이브 배포에 이르기까지 상거래 통합에 대한 우수 사례입니다.
* 성공적인 배포의 유효성 검사를 포함하여 온보딩에 필요한 단계입니다.
* 구성 파일은 온보딩 프로세스를 사용자 지정하는 데 사용됩니다.
* 이벤트 공급자와 구독을 만들고 구성하려면 스크립트를 실행합니다.

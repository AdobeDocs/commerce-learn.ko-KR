...
모든 Adobe Commerce 및 Magento Open Source 설치는 웹 사이트, 스토어 및 스토어 조회수 계층을 지원합니다. 비즈니스 요구 사항에 따라 이 계층을 구축하고 확장할 수 있습니다.
...
* [루트 범주 및 계층 구조 - [!DNL Commerce] 카탈로그 관리 가이드](https://experienceleague.adobe.com/docs/commerce-admin/catalog/categories/category-root.html?lang=ko)

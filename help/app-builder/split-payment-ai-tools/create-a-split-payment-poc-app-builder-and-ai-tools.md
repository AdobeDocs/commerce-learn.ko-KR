...
>[!VIDEO](https://video.tv.adobe.com/v/3483940?captions=kor&learn=on)
...
PHP에 유지되어야 하는 사항: Commerce 요청 주기에서 동기적으로 실행되거나 깨끗한 외부 표면이 없이 Commerce 내부 API를 호출하는 모든 사항
App Builder으로 이동하는 것: 이벤트 처리, 연산자 워크플로우, 외부 통합 및 연산자 대면 도구 등 기타 모든 것
